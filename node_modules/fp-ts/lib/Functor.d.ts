 ...
 * @since 1.0.0
 */
export declare function voidRight<F extends URIS3>(F: Functor3<F>): <U, L, A, B>(a: A, fb: Type3<F, U, L, B>) => Type3<F, U, L, A>;
export declare function voidRight<F extends URIS3, U, L>(F: Functor3C<F, U, L>): <A, B>(a: A, fb: Type3<F, U, L, B>) => Type3<F, U, L, A>;
export declare function voidRight<F extends URIS2>(F: Functor2<F>): <L, A, B>(a: A, fb: Type2<F, L, B>) => Type2<F, L, A>;
export declare function voidRight<F extends URIS2, L>(F: Functor2C<F, L>): <A, B>(a: A, fb: Type2<F, L, B>) => Type2<F, L, A>;
export declare function voidRight<F extends URIS>(F: Functor1<F>): <A, B>(a: A, fb: Type<F, B>) => Type<F, A>;
 ...
 * @since 1.0.0
 */
export declare function voidLeft<F extends URIS3>(F: Functor3<F>): <U, L, A, B>(fa: Type3<F, U, L, A>, b: B) => Type3<F, U, L, B>;
export declare function voidLeft<F extends URIS3, U, L>(F: Functor3C<F, U, L>): <A, B>(fa: Type3<F, U, L, A>, b: B) => Type3<F, U, L, B>;
export declare function voidLeft<F extends URIS2>(F: Functor2<F>): <L, A, B>(fa: Type2<F, L, A>, b: B) => Type2<F, L, B>;
export declare function voidLeft<F extends URIS2, L>(F: Functor2C<F, L>): <A, B>(fa: Type2<F, L, A>, b: B) => Type2<F, L, B>;
export declare function voidLeft<F extends URIS>(F: Functor1<F>): <A, B>(fa: Type<F, A>, b: B) => Type<F, B>;
 ...
 * @since 1.0.0
 */
export declare function flap<F extends URIS3>(functor: Functor3<F>): <U, L, A, B>(a: A, ff: Type3<F, U, L, (a: A) => B>) => Type3<F, U, L, B>;
export declare function flap<F extends URIS3, U, L>(functor: Functor3C<F, U, L>): <A, B>(a: A, ff: Type3<F, U, L, (a: A) => B>) => Type3<F, U, L, B>;
export declare function flap<F extends URIS2>(functor: Functor2<F>): <L, A, B>(a: A, ff: Type2<F, L, (a: A) => B>) => Type2<F, L, B>;
export declare function flap<F extends URIS2, L>(functor: Functor2C<F, L>): <A, B>(a: A, ff: Type2<F, L, (a: A) => B>) => Type2<F, L, B>;
export declare function flap<F extends URIS>(functor: Functor1<F>): <A, B>(a: A, ff: Type<F, (a: A) => B>) => Type<F, B>;
