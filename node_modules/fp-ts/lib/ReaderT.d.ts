...
export interface ReaderT2v2<M extends URIS2> {
    ...
    readonly chain: <L, E, A, B>(fa: (e: E) => Type2<M, L, A>, f: (a: A) => (e: E) => Type2<M, L, B>) => (e: E) => Type2<M, L, B>;
}
export interface ReaderT2v3<M extends URIS3> {
    ...
    readonly chain: <U, L, E, A, B>(fa: (e: E) => Type3<M, U, L, A>, f: (a: A) => (e: E) => Type3<M, U, L, B>) => (e: E) => Type3<M, U, L, B>;
}
/**
 * @since 1.2.0
 */
