...
var NonEmptyArray = /** @class */ (function () {
    ...
    NonEmptyArray.prototype.lookup = function (i) {
        return i === 0 ? Option_1.some(this.head) : Array_1.lookup(i - 1, this.tail);
    };
    /**
     * Use `lookup` instead
     * @since 1.11.0
    ...
    NonEmptyArray.prototype.updateAt = function (i, a) {
        if (i === 0) {
            return this.head === a ? Option_1.some(this) : Option_1.some(new NonEmptyArray(a, this.tail));
        }
        else {
            var t = Array_1.updateAt(i - 1, a, this.tail);
            return t.isSome() ? (t.value === this.tail ? Option_1.some(this) : Option_1.some(new NonEmptyArray(this.head, t.value))) : Option_1.none;
        }
    };
...
exports.getSetoid = function (S) {
    var setoidTail = Setoid_1.getArraySetoid(S);
    return Setoid_1.fromEquals(function (x, y) { return S.equals(x.head, y.head) && setoidTail.equals(x.tail, y.tail); });
};
/**
