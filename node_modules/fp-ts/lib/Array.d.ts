 ...
 * @since 1.16.0
 */
export declare const findFirstMap: <A, B>(arr: A[], f: (a: A) => Option<B>) => Option<B>;
/**
 ...
 * @since 1.16.0
 */
export declare const findLastMap: <A, B>(arr: A[], f: (a: A) => Option<B>) => Option<B>;
/**
 ...
 * @since 1.14.0
 */
export declare const elem: <A>(S: Setoid<A>) => (a: A, as: A[]) => boolean;
/**
 * Use `elem` instead
 * @since 1.3.0
 * @deprecated
