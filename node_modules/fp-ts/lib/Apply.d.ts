 ...
 * @deprecated
 */
export declare function liftA2<F extends URIS3>(F: Apply3<F>): <A, B, C>(f: Curried2<A, B, C>) => <U, L>(fa: Type3<F, U, L, A>) => (fb: Type3<F, U, L, B>) => Type3<F, U, L, C>;
export declare function liftA2<F extends URIS3, U, L>(F: Apply3C<F, U, L>): <A, B, C>(f: Curried2<A, B, C>) => (fa: Type3<F, U, L, A>) => (fb: Type3<F, U, L, B>) => Type3<F, U, L, C>;
export declare function liftA2<F extends URIS2>(F: Apply2<F>): <A, B, C>(f: Curried2<A, B, C>) => <L>(fa: Type2<F, L, A>) => (fb: Type2<F, L, B>) => Type2<F, L, C>;
export declare function liftA2<F extends URIS2, L>(F: Apply2C<F, L>): <A, B, C>(f: Curried2<A, B, C>) => (fa: Type2<F, L, A>) => (fb: Type2<F, L, B>) => Type2<F, L, C>;
export declare function liftA2<F extends URIS>(F: Apply1<F>): <A, B, C>(f: Curried2<A, B, C>) => Curried2<Type<F, A>, Type<F, B>, Type<F, C>>;
/** @deprecated */
 ...
 * @deprecated
 */
export declare function liftA3<F extends URIS3>(F: Apply3<F>): <A, B, C, D>(f: Curried3<A, B, C, D>) => <U, L>(fa: Type3<F, U, L, A>) => (fb: Type3<F, U, L, B>) => (fc: Type3<F, U, L, C>) => Type3<F, U, L, D>;
export declare function liftA3<F extends URIS3, U, L>(F: Apply3C<F, U, L>): <A, B, C, D>(f: Curried3<A, B, C, D>) => (fa: Type3<F, U, L, A>) => (fb: Type3<F, U, L, B>) => (fc: Type3<F, U, L, C>) => Type3<F, U, L, D>;
export declare function liftA3<F extends URIS2>(F: Apply2<F>): <A, B, C, D>(f: Curried3<A, B, C, D>) => <L>(fa: Type2<F, L, A>) => (fb: Type2<F, L, B>) => (fc: Type2<F, L, C>) => Type2<F, L, D>;
export declare function liftA3<F extends URIS2, L>(F: Apply2C<F, L>): <A, B, C, D>(f: Curried3<A, B, C, D>) => (fa: Type2<F, L, A>) => (fb: Type2<F, L, B>) => (fc: Type2<F, L, C>) => Type2<F, L, D>;
export declare function liftA3<F extends URIS>(F: Apply1<F>): <A, B, C, D>(f: Curried3<A, B, C, D>) => Curried3<Type<F, A>, Type<F, B>, Type<F, C>, Type<F, D>>;
/** @deprecated */
 ...
 * @deprecated
 */
export declare function liftA4<F extends URIS3>(F: Apply3<F>): <A, B, C, D, E>(f: Curried4<A, B, C, D, E>) => <U, L>(fa: Type3<F, U, L, A>) => (fb: Type3<F, U, L, B>) => (fc: Type3<F, U, L, C>) => (fd: Type3<F, U, L, D>) => Type3<F, U, L, E>;
export declare function liftA4<F extends URIS3, U, L>(F: Apply3C<F, U, L>): <A, B, C, D, E>(f: Curried4<A, B, C, D, E>) => (fa: Type3<F, U, L, A>) => (fb: Type3<F, U, L, B>) => (fc: Type3<F, U, L, C>) => (fd: Type3<F, U, L, D>) => Type3<F, U, L, E>;
export declare function liftA4<F extends URIS2>(F: Apply2<F>): <A, B, C, D, E>(f: Curried4<A, B, C, D, E>) => <L>(fa: Type2<F, L, A>) => (fb: Type2<F, L, B>) => (fc: Type2<F, L, C>) => (fd: Type2<F, L, D>) => Type2<F, L, E>;
export declare function liftA4<F extends URIS2, L>(F: Apply2C<F, L>): <A, B, C, D, E>(f: Curried4<A, B, C, D, E>) => (fa: Type2<F, L, A>) => (fb: Type2<F, L, B>) => (fc: Type2<F, L, C>) => (fd: Type2<F, L, D>) => Type2<F, L, E>;
export declare function liftA4<F extends URIS>(F: Apply1<F>): <A, B, C, D, E>(f: Curried4<A, B, C, D, E>) => Curried4<Type<F, A>, Type<F, B>, Type<F, C>, Type<F, D>, Type<F, E>>;
/** @deprecated */
...
export interface SequenceT3<F extends URIS3> {
    <U, L, T extends Array<Type3<F, U, L, any>>>(...t: T & {
        0: Type3<F, U, L, any>;
    }): Type3<F, U, L, {
...
export interface SequenceT3C<F extends URIS3, U, L> {
    <T extends Array<Type3<F, U, L, any>>>(...t: T & {
        0: Type3<F, U, L, any>;
    }): Type3<F, U, L, {
        [K in keyof T]: [T[K]] extends [Type3<F, U, L, infer A>] ? A : never;
    }>;
...
export interface SequenceT2<F extends URIS2> {
    <L, T extends Array<Type2<F, L, any>>>(...t: T & {
        0: Type2<F, L, any>;
    }): Type2<F, L, {
...
export interface SequenceT2C<F extends URIS2, L> {
    <T extends Array<Type2<F, L, any>>>(...t: T & {
        0: Type2<F, L, any>;
    }): Type2<F, L, {
        [K in keyof T]: [T[K]] extends [Type2<F, L, infer A>] ? A : never;
    }>;
...
export interface SequenceT1<F extends URIS> {
    <T extends Array<Type<F, any>>>(...t: T & {
        0: Type<F, any>;
    }): Type<F, {
