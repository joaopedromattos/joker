...
const _findPackage = ({ filePath, name, pkgMap, rootPath, }) => {
    const resolvedRoot = path_1.resolve(rootPath);
    // Iterate down potential paths.
    let curFilePath = filePath;
    let isFlattened = false;
    while (resolvedRoot.length <= path_1.resolve(curFilePath).length) {
        // Check at this level.
...
const _recurseDependencies = ({ filePath, foundMap, names, pkgMap, pkgsFilter, rootPath, }) => {
    // Build up cache.
