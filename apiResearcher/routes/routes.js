...
module.exports = app => {
    ...
    app.route("/researchers").post(researcher.createResearcher); // Create
    // .get(researcher.listResearchers)

    app.route("/researchers/email=:email").get(researcher.getResearcher); // Read
    ...
    app.route("/studies").post(study.createStudy); // Create
    ...
    app.route("/boards").get(board.listBoard);
    ...
    app.route("/fetchBoard/_id=:_id").get(welcome.createWelcomeBoard);
    ...
    app.route("/countResults/studyId=:studyId").get(board.countBoards);
};
