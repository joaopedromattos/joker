...
class ListTitle extends Component {
  ...
  render() {
    ...
    const { dragHandleProps, listTitle, listId } = this.props;
    return (
      <div className="list-header">
        ...
        <Wrapper className="delete-list-wrapper" onSelection={this.deleteList}>
          ...
          <Menu className="delete-list-menu">
            <div className="delete-list-header"><strong>Atenção:</strong> antes de deletar esta categoria, por favor, retorne com os cartões para a área inicial.</div>
            <MenuItem className="delete-list-confirm">Deletar</MenuItem>
          </Menu>
        </Wrapper>) }
